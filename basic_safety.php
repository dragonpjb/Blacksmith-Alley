	...
	<div id="content_main">
		...
		<div id="level-3" class="level">
			<div id="l-3" class="col-2 left">
				<h2>Rule #2 - Always have a fire extinguisher handy.</h2>
				<p>Blacksmithing involves fire. Any time an activity involves using an open flame, the fire can get away from you. When this happens an extinguisher is needed to put out the fire quickly. This is especially important if your hair or clothing catches on fire.</p>
			</div><!--l-3-->
		...
		<div id="level-5" class="level">
			<div id="l-5" class="col-2 left">
				<h2>Rule #5 - Always dress appropriately.</h2>
				<ul id="rule5">
